...
// naming/discovery rules live in brainstorms.core.ts. Mirrors pid-apps.io.ts
...
export const BrainstormsIoLive: Layer.Layer<BrainstormsService, never, ProjectsService> =
  Layer.effect(
    BrainstormsService,
    Effect.gen(function* () {
