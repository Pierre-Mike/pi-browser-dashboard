...
import { type GitClientRecorder, GitClientTestLayer, makeGitClientRecorder } from "./installer.io"
import { LibraryIoLive, LibraryService } from "./library.io"
...
const withLayer = <A, E>(
  ...
  const configLayer = ConfigIoTest({ projectsRoot, claudeConfigDir: join(homeShim, ".claude") })
...
describe("LibraryIo readCatalog", () => {
...
describe("LibraryIo listAgenticRepo", () => {
...
describe("LibraryIo installEntry", () => {
...
describe("LibraryIo addEntry / removeEntry", () => {
...
describe("LibraryIo initLibrary", () => {
