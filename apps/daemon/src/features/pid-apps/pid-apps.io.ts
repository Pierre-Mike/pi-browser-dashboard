...
// pid-settings.io.ts (Effect Layer over ProjectsService).
...
// half-written index.html. Mirrors pid-settings.io.ts's writeAtomic.
...
export const PidAppsIoLive: Layer.Layer<PidAppsService, never, ProjectsService> = Layer.effect(
  PidAppsService,
  Effect.gen(function* () {
