import type { ThemeSelection } from "../../lib/ui/theme.core"
import { AppearanceFieldset, type SaveMachineDefault } from "./AppearanceFieldset"
...
//
// Appearance is deliberately *not* part of `form`, and sits outside the
// loading/error branch: the theme this browser shows is a localStorage override
// that saves on pick, so the picker keeps working when the settings file does not
// load. Only writing the *machine* default needs the daemon.
export const GlobalSettingsView = ({ form, theme, saveDefault }: Props) => (
  <div data-testid="global-settings-panel" className="flex flex-col gap-4 max-w-3xl">
    ...
    <AppearanceFieldset theme={theme} saveDefault={saveDefault} />
