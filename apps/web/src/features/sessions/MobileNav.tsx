...
export const MobileNav = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <>
      <header className="md:hidden sticky top-0 z-30 flex items-center gap-2 border-b border-base-300 bg-base-100/90 backdrop-blur px-3 py-2">
        <button
          type="button"
      ...
      <button
        ...
        className={`md:hidden fixed inset-0 z-40 bg-base-content/50 transition-opacity duration-200 ${drawerBackdropClass(open)}`}
      />
