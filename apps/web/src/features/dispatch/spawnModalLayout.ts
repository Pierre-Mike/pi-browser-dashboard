...
export const SPAWN_MODAL_SHELL =
  "w-full max-w-3xl rounded-box border border-base-300 bg-base-100 text-base-content shadow-2xl p-4 flex flex-col gap-3"
...
export const SPAWN_SKILLS_CONTAINER =
  "flex flex-wrap content-start gap-1.5 max-h-[60vh] overflow-y-auto overflow-x-hidden rounded-box border border-base-300 bg-base-200 p-2"
...
export const SPAWN_INTENT_INPUT =
  "w-full resize-none rounded-btn border border-base-300 bg-base-100 text-base-content placeholder:text-base-content/40 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-primary"
